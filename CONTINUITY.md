...
- **AI Poet Pipeline:** Roadmap создан, Phase 1 не начата
...
## Now
- AI Poet Pipeline Phase 1: Programmatic Metrics Gate

## Next
- `/gsd-plan-phase 1` — запланировать Phase 1 (banale detector, syllable counter, MATTR-approx)
