...
- AI: OpenRouter → google/gemini-2.5-pro (reasoning: effort high)
...
## State
- **Сейчас**: бот работает ✅, cookie свежая (обновлена вручную 14.04), suno-api авторизован
- **Credits**: 2040/2500
...
- `ensureTokenAlive`: при 3x 500 делает cookie refresh проактивно (до generateCustom)
...
- Деплой: commit 4b71685, credits 2020/2500
