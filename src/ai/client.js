...
═══ WORKFLOW ═══
READ the DETAILS field. Don't just list what's there. Ask yourself:
...
Pick ONE angle — not everything. A song about a tough guy who secretly talks to his dog is better than a song that lists all his hobbies.
Write the song as a MINI-MOVIE:
...
Check technical quality (rhyme, rhythm) only AFTER the story and emotion work.
...
CHORUS RULE: The chorus is the HEART of the song. It must pass this test: if you remove the person's name, could this chorus be about literally anyone? If yes — rewrite. A good chorus captures ONE specific thing about THIS person that makes them THEM.
...
Ты не ждёшь, пока тебя догонит свет —
Сам находишь то, что другие ищут впереди.
WHY GOOD: ONE central image — "город просыпается, а ты давно в пути" — captures his ENTIRE personality (early riser, ahead of everyone, driven). Not a hobby list. The chorus is about a FEELING (being ahead, being in motion), not about listing gym+bike+hunting. If you remove "Рома" — it's still about a specific TYPE of person, not just generic praise. "Ты не ждёшь, пока тебя догонит свет" — poetic but simple, feels like a real toast.
[Бридж — GOOD]
